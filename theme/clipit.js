...
export const clipitTheme = {
  ...
  tokens: {
    ...
    "--color-neutral": "light-dark(#211A161A, #E7E2D933)",
    "--color-overlay": "light-dark(#211A1666, #1E1B1599)",
    "--color-overlay-hover": "light-dark(#211A160D, #FFFFFF0D)",
    "--color-overlay-pressed": "light-dark(#211A161A, #FFFFFF1A)",
    "--color-text-primary": "light-dark(#111113, #f4f4f5)",
    "--color-text-secondary": "light-dark(#52443D, #B1AA9D)",
    "--color-text-disabled": "light-dark(#9D8E85, #645E51)",
    "--color-text-accent": "var(--color-accent)",
    "--color-on-dark": "#ffffff",
    "--color-on-light": "#171717",
    "--color-on-accent": "light-dark(#FFFFFF, #422E00)",
    ...
    "--color-icon-primary": "light-dark(#211A16, #E7E2D9)",
    "--color-icon-secondary": "light-dark(#52443D, #B1AA9D)",
    "--color-icon-disabled": "light-dark(#9D8E85, #645E51)",
