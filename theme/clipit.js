...
/**
 * clipit theme — built by `npx astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { clipitTheme } from './clipit';
 *   import './clipit.css';
 */
export const clipitTheme = {
  name: 'clipit',
  __built: true,
  tokens: {
    ...
    "--color-background-surface": "light-dark(#ffffff, #101314)",
    "--color-background-body": "light-dark(#ffffff, #101314)",
    "--color-background-card": "light-dark(#fafafa, #1a1d20)",
    "--color-background-popover": "light-dark(#ffffff, #24292D)",
    "--color-background-muted": "light-dark(#f4f4f5, #24292D)",
    "--color-accent": "light-dark(#006982, #61D3FF)",
    ...
    "--color-neutral": "light-dark(#131D201A, #D9E4EA33)",
    ...
    "--color-error": "light-dark(#5e3a35, #c6a6a2)",
    "--color-warning": "light-dark(#876515, #d3c490)",
    ...
    "--color-skeleton": "light-dark(#e4e4e7, #495056)",
    "--color-shadow": "light-dark(#0000002e, #0000004D)",
    ...
    "--color-track": "light-dark(#9BAFB5, #394951)"
  },
  components: {
    "heading": {
      "level:1": {
