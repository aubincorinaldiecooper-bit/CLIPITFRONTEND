...
/**
 * Shadcn Space's tooltip, on Base UI. Portalled to the body, so the popup
 * carries `.shadcn-scope` itself: outside the workspace subtree the tokens
 * would resolve to the dark app's values (see app/globals.css).
 */
  ...
  return (
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Positioner
        ...
        className="shadcn-scope isolate z-50"
      >
