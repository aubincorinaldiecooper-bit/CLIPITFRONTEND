...
const primaryGradient =
  "bg-[linear-gradient(135deg,#d8f6ff_0%,#a9e3ff_48%,#bfcbff_100%)] text-[#102033] shadow-[0_8px_24px_rgba(121,199,255,0.22)] hover:brightness-[0.985]"

export function SearchShell({ children }: { children: React.ReactNode }) {
  return (
    <WorkspaceSignInGate>
      <div
        className="shadcn-scope flex min-h-dvh w-full flex-col bg-[#f8fbfe] text-[#111827]"
      ...
      >
        ...
        <header className="flex h-16 shrink-0 items-center justify-between border-b border-[#e8eef5] bg-white/85 px-4 backdrop-blur-xl sm:px-6">
          <a href="/start" aria-label="Clipit" className="flex items-center text-foreground">
            <Logo size={20} />
          </a>
          ...
          <div className="flex items-center gap-2">
            <motion.a
              ...
              className={cn(
                ...
                primaryGradient,
                "h-9 rounded-full border-0 px-3.5 font-medium",
              )}
            >
