 ...
 *
 * Upload is a full navigation (<a>, not <Link>) on purpose: landing on
 * /start resets the flow, and client-side navigation would carry stale
 * upload state into a screen that promises a fresh start.
 */
